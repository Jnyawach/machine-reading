        ...
        <div>
            ...
            <div id="dropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 divide-y" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <Link :href="route('auth.editProfile')" class="block px-4 py-2 hover:bg-gray-100">
                            Profile
                        </Link>
                    </li>
                    <li>
        ...
        <div class="h-full px-5 py-4 overflow-y-auto bg-white">
            ...
            <ul class="space-y-2 font-medium pt-3 min-h-[45vh] border-b border-gray-300 text-sm">
                ...
                <li>
                    ...
                    >
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'admin/products/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <li>
                    ...
                    >
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'admin/machines/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <li>
                    ...
                    >
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'admin/shifts/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="my-5">
                <ul class="space-y-2 font-medium pt-3 text-sm">
                    <li>
                        <Link :href="route('auth.editProfile')" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-sky-700  hover:bg-gray-100 group">
