        ...
        <div>
            ...
            <div id="dropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 divide-y" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <Link :href="route('auth.editProfile.user')" class="block px-4 py-2 hover:bg-gray-100">
                            Profile
                        </Link>
                    </li>
                    <li>
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-white shadow-r-lg border-r" aria-label="Sidebar">
        <div class="h-full px-5 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <div class="my-5 bg-sky-50 rounded-xl p-2 ">
                <div class="flex gap-2 items-center border-b py-3 border-gray-300">
                    ...
                    <div>
                        ...
                        <Link :href="route('auth.editProfile.user')" class="text-sky-700 text-sm">Edit profile</Link>
                    </div>
                </div>
                <div class="py-3">
            ...
            <ul class="space-y-2 font-medium pt-3 min-h-[45vh] border-b border-gray-300 text-sm">
                <li>
                    <Link :href="route('user.index')" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-sky-700  hover:bg-gray-100 group"
                          :class="{ 'bg-gray-100 text-sky-700': $page.component === 'user/index' }"
                    >
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'user/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <li v-if="$page.props.auth.permissions.includes('reading')">
                    ...
                    >
                        ...
                        <svg class="h-5 fill-gray-900 group-hover:fill-sky-700" :class="{ 'fill-sky-700': $page.component === 'user/reading/index' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            ...
            <div class="my-5">
                <ul class="space-y-2 font-medium pt-3 text-sm">
                    <li>
                        <Link :href="route('auth.editProfile.user')" class="flex items-center p-2 text-gray-900 rounded-lg hover:text-sky-700  hover:bg-gray-100 group">
